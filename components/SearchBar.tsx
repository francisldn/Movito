...
const Search = ({page, setPage,searchList, setSearchList, allList, searchTitle, setSearchTitle}: SearchProps) => {
    ...
    return (
        <div className="flex mx-4 md:mx-8 space-x-5 max-w-[calc(100vw-14rem)] h-8 md:h-10 my-5 items-center mt-20 lg:mt-6">
            ...
            <input 
                ...
                className="bg-[#10141e] drop-shadow-[0_4px_4px_rgba(0, 0, 0, 0.25)] cursor-pointer focus:outline-hidden focus:border-0 w-full mx-4 text-[18px] md:text-[24px] h-full focus:placeholder:!text-transparent"/>
        </div>
    );
}
